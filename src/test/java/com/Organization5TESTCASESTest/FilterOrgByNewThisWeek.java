...
public class FilterOrgByNewThisWeek extends BaseClass {
	@Test
	public void main() throws EncryptedDocumentException, IOException {
		...
		//Filter Organization By New This Week
		...
		WebDriverUtility.dropDownHandlebyVisibleText(dropdown, "New This Week");
